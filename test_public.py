...
PUBLIC_DIR = r"C:\Users\repre\Documents\Mro papeleria\public_html"
...
if missing:
    print("Found missing files (404s):")
    for src, m in set(missing):
        print(f"  In {src}: {m}")
else:
    print("All internal links and assets exist! No 404s detected.")
